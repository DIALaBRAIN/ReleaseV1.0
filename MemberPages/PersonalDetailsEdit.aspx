<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="PersonalDetailsEdit.aspx.cs"
    MasterPageFile="~/StandardMaster.master" Inherits="IntelArcade.WebApp.PersonalDetailsEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <div style="float: right; padding: 10px;">
        <asp:ImageButton runat="server" ID="SubmitButton" ImageUrl="~/images/btn_create.png" />&nbsp;<asp:ImageButton runat="server"
            ID="CancelButton" CausesValidation="false" ImageUrl="~/images/btn_cancel.png" /></div>
</asp:Content>
