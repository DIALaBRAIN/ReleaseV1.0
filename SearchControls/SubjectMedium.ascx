<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectMedium.ascx.cs" Inherits="IntelArcade.WebApp.SearchControls.SubjectMedium" %>
                ...
                <div class="inner">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" >
                        <tr style="vertical-align:top;">
                            ...
                            <td rowspan="3"><iac:ProfileFlagRenderer runat="server" ID="ProfileFlagRenderer1" EnableViewState="false" OnClientDialogClosed="_iac_SbjSchOnClientClose" Mode="Icons" UserFlags="<%# GetUserFlags(Container.DataItem) %>" ServiceProfileID="<%# ((ServiceProfileResultItem)Container.DataItem).ServiceProfileID %>" ProviderID="<%# ((ServiceProfileResultItem)Container.DataItem).ProviderUserID %>" ServiceProfileFlags="<%# GetSubjectFlags(Container.DataItem) %>" /></td>
                        </tr>
                        <tr>
