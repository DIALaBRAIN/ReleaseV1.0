...
var BrowserDetection = {
	...
	positionNotice: function(){
		...
		noticeEl.style.left = (windowSize.width - 700) / 2 + "px";
	...
	defaultNotSupportedBrowsers: [{ 'os': 'Any', 'browser': 'Opera', 'version': 'Any' }, { 'os': 'Any', 'browser': 'MSIE', 'version': 10}, { 'os': 'Any', 'browser': 'MSIE', 'version': 7 }, { 'os': 'Any', 'browser': 'MSIE', 'version': 6 }],
	noticeText: {
	    'professional': { "title": "Outdated or Unsupported Browser Detected", "notice": "Our website has detected that you are using an outdated or an unsupported browser. Using your current browser will <b style='color:#000'>prevent you from accessing latest features on our website</b>. We strongly recommend to improve your browsing experience on our website.", "selectBrowser": "<b style='color:#000'>Use the links below to download a new browser or upgrade your existing browser.</b>", "": "", "": "" },
