        ...
        window.SchedulerAdvancedTemplate.prototype =
{
    initialize: function () {
        ...
        //        if ($telerik.isIE) {
        //            var textarea = this._getSubjectTextBox();
        //            if (textarea) {
        //                textarea = textarea().get_element();
    ...
    _initializePickers: function () {
        ...
        this._pickers =
		{
		    ...
		    "endTime": $find(templateId + "_EndTime1"),
		    "startDate2": $find(templateId + "_StartDate2"),
		    "startTime2": $find(templateId + "_StartTime2"),
		    "endTime2": $find(templateId + "_EndTime2"),
            "startDate3": $find(templateId + "_StartDate3"),
            "startTime3": $find(templateId + "_StartTime3"),
		    "endTime3": $find(templateId + "_EndTime3"),
		};
        ...
        var pickerControls = [
                    ...
                    $get(this._pickers.startDate2.get_element().id + "_wrapper"),
                    $get(this._pickers.startTime2.get_element().id + "_wrapper"),
					$get(this._pickers.startTime2.get_element().id + "_timeView_wrapper"),
                    $get(this._pickers.endTime2.get_element().id + "_wrapper"),
					$get(this._pickers.endTime2.get_element().id + "_timeView_wrapper"),
                    $get(this._pickers.startDate3.get_element().id + "_wrapper"),
                    $get(this._pickers.startTime3.get_element().id + "_wrapper"),
					$get(this._pickers.startTime3.get_element().id + "_timeView_wrapper"),
                    $get(this._pickers.endTime3.get_element().id + "_wrapper"),
				];
...
function schedulerFormCreated(scheduler, eventArgs) {
    ...
    if (mode == Telerik.Web.UI.SchedulerFormMode.AdvancedInsert ||
        ...
        if (typeof(__iac_schedulerFormCreated) == "function")
        {
            __iac_schedulerFormCreated(scheduler, eventArgs);
        }
...
function schedulerFormClosed()
{
    alert("schedulerFormClosed");
    if (typeof(__iac_schedulerFormClosed) == "function")
    {
        __iac_schedulerFormClosed();
    }
}
