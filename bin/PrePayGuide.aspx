...
<p class="headingsNew">PrePay d<span class="highlight">b</span>-<i>Time</i></p>
 <p>
       ...
       <img src="images/free.png" alt="" class="leftImage" width="50px" height="50px" style="padding-left:10px"/>
       <div style="padding-top:7px;"><b><i>Free calls - if cut-short</i></b><br/>If you see this icon there is no charge for your first meeting (Durations cannot be altered).</div><br/>
      ...
      5 hours of <b>d<span class="highlight2">b</span></b>-<i>Time</i>.....</div><br/><br/>
...
<More>
   <p class="headingsNew">PrePay d<span class="highlight">b</span>-<i>Time</i></p>
    ...
    <p>
     <img src="images/free.png" alt="" class="leftImage" width="50px" height="50px" style="padding-left:10px"/><div style="padding-top:7px;"><b><i>Free calls - if cut-short</i></b><br/>If you see this icon there is no charge for your first meeting (Durations cannot be altered).</div><br/>
      <img src="images/prepay5.png" alt="" class="leftImage" width="50px" height="50px" style="padding-left:10px"/><div style="padding-top:7px;"><b><i>Prepay 5</i></b><br/> 
